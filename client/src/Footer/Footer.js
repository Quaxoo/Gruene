        ...
        <footer>
            <div className='links'>
                <div className='social'>
                    <a className='icon' href='https://www.instagram.com/gudrun.hackl.stoll.gruene/' target='_blank' rel="noreferrer">
            ...
            <div className='credit'>
                <p>Webseite erstellt von <span className='placeholder'><a className='shown' href='mailto:max@van-kemena.de'>Max van Kemenade</a><a className='hidden' href='mailto:max@van-kemena.de'>max@van-kemena.de</a></span></p>
