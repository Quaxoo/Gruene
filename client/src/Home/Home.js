...
import {ReactComponent as Gemeinschaft} from "../assets/icons/gemeinschaft.svg"
        ...
        <section className='home'>
            ...
            <div className='promise gruene-font'>
                ...
                <div className='wrapper'>
                    <div>
                        <Klima/>
                        <p>Weiterentwicklung <br/> der <br/> Klimaschutzgemeinde</p>
                    </div>
                    <div>
                        <Finanzen/>
                        <p>Solide Finanzen</p>
                    ...
                    <div>
                        <Generationen/>
                        <p>Gemeinde für alle <br/> Generationen <br/> lebenswert gestalten</p>
                    </div>
                    <div>
                        <Transparenz/>
                        <p>Transparenz <br/> und <br/> Bürgerbeteiligung</p>
                    </div>
                    <div>
                        <Gemeinschaft/>
                        <p>Gemeinschaft stärken</p>
                    </div>
                </div>
